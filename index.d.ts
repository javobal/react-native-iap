 ...
 * @returns {Promise<Product>}
 */
export declare const getPromotedProductIOS: () => Promise<string>;
/**
 ...
 */
export declare const validateReceiptAndroid: (packageName: string, productId: string, productToken: string, accessToken: string, isSub?: boolean) => Promise<Record<string, unknown> | false>;
/**
...
declare const iapUtils: {
    ...
    validateReceiptAndroid: (packageName: string, productId: string, productToken: string, accessToken: string, isSub?: boolean) => Promise<Record<string, unknown> | false>;
