 ...
 */
export declare const requestPurchase: (sku: string, andDangerouslyFinishTransactionAutomaticallyIOS?: boolean, developerIdAndroid?: string, accountIdAndroid?: string) => Promise<InAppPurchase>;
/**
 * Request a purchase for product. This will be received in `PurchaseUpdatedListener`.
 * @param {string} sku The product's sku/ID
 * @param {boolean} [andDangerouslyFinishTransactionAutomaticallyIOS] You should set this to false and call finishTransaction manually when you have delivered the purchased goods to the user. It defaults to true to provide backwards compatibility. Will default to false in version 4.0.0.
 ...
 */
export declare const validateReceiptIos: (receiptBody: object, isTest?: boolean) => Promise<Apple.ReceiptValidationResponse | false>;
/**
 ...
 */
export declare const validateReceiptAndroid: (packageName: string, productId: string, productToken: string, accessToken: string, isSub?: boolean) => Promise<object | false>;
/**
 * Add IAP purchase event in ios.
 * @returns {callback(e: InAppPurchase | ProductPurchase)}
 */
export declare const purchaseUpdatedListener: (e: InAppPurchase | SubscriptionPurchase | any) => EmitterSubscription;
/**
 * Add IAP purchase error event in ios.
 * @returns {callback(e: PurchaseError)}
 */
export declare const purchaseErrorListener: (e: PurchaseError | any) => EmitterSubscription;
/**
...
declare const iapUtils: {
    ...
    validateReceiptIos: (receiptBody: object, isTest?: boolean) => Promise<Apple.ReceiptValidationResponse | false>;
    validateReceiptAndroid: (packageName: string, productId: string, productToken: string, accessToken: string, isSub?: boolean) => Promise<object | false>;
    requestPurchase: (sku: string, andDangerouslyFinishTransactionAutomaticallyIOS?: boolean, developerIdAndroid?: string, accountIdAndroid?: string) => Promise<InAppPurchase>;
    ...
    purchaseUpdatedListener: (e: InAppPurchase | SubscriptionPurchase | any) => EmitterSubscription;
    purchaseErrorListener: (e: PurchaseError | any) => EmitterSubscription;
